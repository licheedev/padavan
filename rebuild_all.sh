...
cp configs/boards/NEWIFI-MINI/libc.config configs/boards/NEWIFI-Y1S/libc.config
echo "build GWAN"
...
cp configs/boards/NEWIFI-MINI/libc.config configs/boards/PSG1218/libc.config
./clear_tree
./build_firmware
