...
cp configs/uclibc-mipsel.config configs/boards/NEWIFI-MINI/libc.config
./clear_tree
./build_firmware
...
cp configs/uclibc-mipsel.config configs/boards/NEWIFI-Y1S/libc.config
echo "build GWAN"
...
cp configs/uclibc-mipsel.config configs/boards/NEWIFI-D1/libc.config
./clear_tree
./build_firmware
...
cp configs/uclibc-mipsel.config configs/boards/PSG1218/libc.config
./clear_tree
./build_firmware
